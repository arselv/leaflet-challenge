...
var geoBounderies = "GeoJSON/PB2002_boundaries.json";
var urlData ;
var tactonicData = [];
...
d3.json(queryUrl, function(data) {
  ...
  // console.log(tectonicplates.features)
  // createFeatures(data.features, tectonicplates.features);
  urlData = data.features;
});

d3.json(geoBounderies, function(data) {
  tactonicData = data.features;
});
